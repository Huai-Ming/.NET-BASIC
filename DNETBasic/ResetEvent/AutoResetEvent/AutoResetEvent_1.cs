...
namespace ResetEvent.AutoResetEvent
{
    //https://msdn.microsoft.com/en-us/library/system.threading.autoresetevent(v=vs.110).aspx
    public class AutoResetEvent_1
    {
        private static System.Threading.AutoResetEvent event_1 = new System.Threading.AutoResetEvent(true);
